...
#+BEGIN_SRC emacs-lisp
  (use-package elscreen
    ...
    (setq elscreen-tab-display-kill-screen nil);; Do not display [X]
    (setq elscreen-tab-display-control nil);; Do not display [<->]
    (setq elscreen-display-tab nil);; Do not display tabs
    )
#+END_SRC
